...
test_them_values() ->
    [
        ...
        ?_assertEqual([["A2", "B2", "C2", "D2", "E2", "F2", "G2", "H2", "I2"],
                            ...
                            dict:fetch("C2", sudoku_serv:units())),

        ?_assertEqual(["A1", "A2", "A3", "B1", "B2", "B3", "C1", "C3",
                            "C4", "C5", "C6", "C7", "C8", "C9", "D2", "E2",
                            "F2", "G2", "H2", "I2"],
                            dict:fetch("C2", sudoku_serv:peers())),
        ...
        ?_assert(lists:all(fun(X) -> Peers = sudoku_serv:peers(),
                                        PeersOfX = dict:fetch(X, Peers),
                                        length(PeersOfX) =:= 20 end, sudoku_serv:squares())),
        ?_assertEqual(dict:from_list([{"A1","4"},{"A2","1679"},{"A3","12679"},{"A4","139"},{"A5","2369"},{"A6","269"},{"A7","8"},{"A8","1239"},{"A9","5"},
        ...
        ?_assertEqual(dict:from_list([{"A1","4"},{"A2","1"},{"A3","7"},{"A4","3"},{"A5","6"},{"A6","9"},{"A7","8"},{"A8","2"},{"A9","5"},
